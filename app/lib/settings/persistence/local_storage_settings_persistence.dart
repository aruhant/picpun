...
class LocalStorageSettingsPersistence extends SettingsPersistence {
  ...
  @override
  Future<bool> getCheatOn({required bool defaultValue}) async {
    final prefs = await instanceFuture;
    return prefs.getBool('cheatOn') ?? defaultValue;
  }

  @override
  Future<void> saveCheatOn(bool value) async {
    final prefs = await instanceFuture;
    await prefs.setBool('cheatOn', value);
  }
}
