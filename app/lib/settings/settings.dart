...
class SettingsController {
  ...
  ValueNotifier<bool> cheatOn = ValueNotifier(false);
  ...
  void setPlayerName(String name) {
    ...
    if (name.toLowerCase() == 'iddqd') {
      cheatOn.value = true;
      _store.saveCheatOn(cheatOn.value);
    }
  ...
  void toggleAudioOn() {
    ...
    musicOn.value = audioOn.value;
    soundsOn.value = audioOn.value;
    _store.saveMusicOn(audioOn.value);
    _store.saveSoundsOn(audioOn.value);
  ...
  Future<void> _loadStateFromPersistence() async {
    final loadedValues = await Future.wait([
      ...
      _store
          .getCheatOn(defaultValue: false)
          .then((value) => cheatOn.value = value),
    ]);
